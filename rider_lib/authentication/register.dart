...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _getImage() async {
    ...
    setState(() {
      ...
      final storageRef = fStorage.FirebaseStorage.instance.ref().child("riders").child(fileName);
      fStorage.UploadTask uploadTask = storageRef.putFile(imageFile);
  ...
  Future<void> _getImage() async
  {
    ...
    final fileBytes = imageXFile!.readAsBytes();
    //imageXFile = await _picker.pickImage(source: ImageSource.gallery);
    setState(() {
      imageXFile;
    });
     String fileName = DateTime.now().millisecondsSinceEpoch.toString();
          ...
          fStorage.UploadTask uploadTask = reference.putData(fileBytes);
  ...
  getCurrentLocation() async
  {
    ...
    completeAddress = '${pMark.subThoroughfare} ${pMark.thoroughfare}, ${pMark.subLocality} ${pMark.locality}, ${pMark.subAdministrativeArea}, ${pMark
